...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-05-2016 a las 15:32:00
...
('S72_3212', 'Pont Yacht', 'Ships', '1:72', 'Unimax Art Galleries', 'Measures 38 inches Long x 33 3/4 inches High. Includes a stand.\r\nMany extras including rigging, long boats, pilot house, anchors, etc. Comes with 2 masts, all square-rigged', 210, 33.3, 54.6);
...
(1, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', NULL, NULL, 'fQ7lXvXy/2J8S97x6V9rT.', 1268889823, 1462087527, 1, 'Admin', 'YoMismo', 'eXpresoWeb', '666999333'),
(2, '::1', NULL, '$2y$08$EfEREsGZ1i4Ib/fx.IuJROaDXKrBeY93fT1jr8/EAPlDGmmqnWSWq', NULL, 'monalcblay@gmail.com', NULL, NULL, NULL, NULL, 1462084236, NULL, 1, 'Otro', 'OtroMismo', 'Cualquiera', '123456789');
